---
name: weekly-summary
description: Generates comprehensive weekly accomplishment report. Use when user says "/weekly-summary", asks for a weekly report, wants a week-in-review, or needs weekly progress summary.
model: sonnet
...
Status: [On track | Progressing | In progress | Behind]
...
- PR #245: Unblocked Sarah on TypeScript generics issue → Staff signal: collaboration
