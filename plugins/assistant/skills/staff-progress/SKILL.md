---
name: staff-progress
description: Checks progress toward Staff Engineer goals. Use when user says "/staff-progress", asks about career progress, wants Staff Engineer tracking, or needs to review staff signals.
model: sonnet
...
Overall Staff Readiness: Strong Progress
