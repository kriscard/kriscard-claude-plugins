---
name: context-save
description: Saves current task context before switching. Use when user says "/context-save", wants to save context, needs to preserve task state, or is about to switch tasks.
model: sonnet
