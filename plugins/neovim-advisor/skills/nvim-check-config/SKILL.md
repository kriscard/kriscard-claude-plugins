...
description: "Validate Neovim configuration for file structure, plugin syntax, best practices, and common mistakes. Use when user says '/neovim-advisor:nvim-check-config', wants config validation, or needs Neovim setup checked."
