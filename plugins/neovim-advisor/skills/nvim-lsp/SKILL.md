---
name: nvim-lsp
description: "Interactive LSP configuration for specific languages with Mason integration. Use when user says '/neovim-advisor:nvim-lsp', wants to set up language servers, or needs LSP configuration help."
