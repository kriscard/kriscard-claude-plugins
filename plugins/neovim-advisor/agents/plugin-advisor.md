---
name: plugin-advisor
description: Analyzes Neovim plugins, suggests modern alternatives, checks for updates and abandoned projects, identifies unused plugins, and recommends gap-filling additions. Use when the user mentions Neovim plugins, asks about plugin alternatives, mentions slow startup with many plugins, asks "is X still the best plugin for Y", or wants to audit their installed plugins.
color: cyan
tools:
  - Read
  - Glob
