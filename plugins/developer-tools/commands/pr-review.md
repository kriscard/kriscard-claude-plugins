---
description: Comprehensive PR review combining code-reviewer agent + react-best-practices skill
...
2. **Audit in parallel:**
   ...
   - **For React/TypeScript files** (`.tsx`, `.jsx`, hooks) → invoke the `react-best-practices` skill
