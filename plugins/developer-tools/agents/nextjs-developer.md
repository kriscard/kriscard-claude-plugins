...
- Use WebSearch/WebFetch to fetch latest Next.js documentation
...
1. Use WebSearch for latest Next.js documentation and patterns
...
1. **Feature Planning**
   - Research latest patterns via WebSearch
