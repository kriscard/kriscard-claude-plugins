---
name: til
description: "Create TIL note from session learnings. Use when user says '/til:til', wants to document what they learned today, or needs to create a Today I Learned note."
