---
name: inspect
description: "Comprehensive page inspection (screenshot + DOM + console + network). Use when user says '/chromedev-tools:inspect', wants to inspect a page, or needs full page analysis."
model: sonnet
