---
name: performance
description: "Record performance trace and analyze Core Web Vitals. Use when user says '/chromedev-tools:performance', wants performance analysis, or needs to measure page speed."
model: sonnet
