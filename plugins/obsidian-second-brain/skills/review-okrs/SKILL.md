---
name: review-okrs
description: "Multi-level OKR reviews (quarterly, monthly, weekly) with progress tracking. Use when user says '/obsidian-second-brain:review-okrs', wants to review goals, or needs OKR check-in."
