---
name: apply-template
description: "Apply templates to notes interactively - select from all available templates. Use when user says '/obsidian-second-brain:apply-template', wants to apply a template, or needs note structure from templates."
