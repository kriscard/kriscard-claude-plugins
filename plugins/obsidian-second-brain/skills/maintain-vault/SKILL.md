---
name: maintain-vault
description: "Comprehensive vault health check - links, tags, 2-Link Rule, Related/Encounters sections. Use when user says '/obsidian-second-brain:maintain-vault', wants vault maintenance, or needs link/tag health checks."
