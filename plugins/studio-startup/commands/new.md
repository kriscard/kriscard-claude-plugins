...
description: Start a new project, startup, or side project with guided workflow from idea to MVP
argument-hint: "[--type=web|mobile|api|cli] [--name=\"Project Name\"] [--phase=strategy|requirements|tech|implementation]"
allowed-tools:
  - AskUserQuestion
  - Read
  - Write
