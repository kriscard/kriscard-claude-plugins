...
description: Recommends optimal tech stacks based on project requirements, team experience, and scalability needs. Presents 2-3 stack options with pros/cons and deployment guidance. Use when the user asks "what tech stack should I use", invokes Phase 3 of studio-startup workflow, has requirements documented and needs stack selection, or asks for framework recommendations.
color: blue
tools:
  - Read
  - Glob
...
- User has finished requirements gathering and asks for tech stack recommendations
- studio-startup orchestrator advances to Phase 3 (Tech Stack Selection)
- User asks "what should I build this with?" or compares frameworks
- User wants 2-3 stack options with trade-off analysis
