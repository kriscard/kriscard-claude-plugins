---
name: issue
description: Analyzes a Jira ticket, implements the fix in small steps on a dedicated branch, and validates with tests and linting. Use when user says "/issue", has a Jira ticket to fix, wants to work on a ticket, or needs to implement a Jira issue.
