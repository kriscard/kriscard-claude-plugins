---
name: init-ultrathink
description: "Initializes a comprehensive CLAUDE.md using ultrathink methodology. Use when user says \"/init-ultrathink\", wants to create a CLAUDE.md, needs to initialize project context, or asks to bootstrap a CLAUDE.md file."
