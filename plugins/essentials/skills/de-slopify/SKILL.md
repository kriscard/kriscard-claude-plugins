---
name: de-slopify
description: Removes AI-generated comments from the current branch. Use when user says "/de-slopify", wants to clean up AI slop, needs to remove AI comments, or wants to strip generated comments from code.
