---
name: analyze-repo
description: "Performs comprehensive repository analysis — generates architecture documentation and/or a CLAUDE.md. Use when user says '/analyze-repo', wants repo analysis, needs codebase documentation, wants to create a CLAUDE.md, or asks to bootstrap project context."
