---
name: spec
description: Creates a lightweight spec from a ticket or prompt with minimal questions. Use when user says "/spec", wants to generate a spec, needs a specification document, or asks to spec out a feature.
