---
name: analyze-repo
description: "Perform comprehensive repository analysis and create detailed documentation. Use when user says '/architecture:analyze-repo', wants repo analysis, or needs codebase documentation."
