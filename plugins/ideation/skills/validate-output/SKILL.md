...
description: "Validate ideation workflow outputs (contracts, PRDs, specs) for completeness and quality. Use when user says '/ideation:validate-output', wants to validate ideation artifacts, or needs output quality checks."
