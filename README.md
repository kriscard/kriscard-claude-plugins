...
| [developer-tools](./plugins/developer-tools) | Coding, frontend, and debugging specialists | **Commands:** `/react-best-practices` (audit), `/pr-review` (PR audit chain)<br>**Natural language:** "Build a login form", "Fix this bug" — routes to the right specialist (frontend-developer, typescript-coder, nextjs-developer, debugger, coder, refactoring, security)<br>**Skill:** `react-best-practices` auto-triggers on React audits (12 thematic references + universal checks) |
